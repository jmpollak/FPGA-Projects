...
HD_PWD='C:/Users/polla/Documents/ECE 3300/BitCounter/BitCounter.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bit_counter.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bit_counter.tcl
