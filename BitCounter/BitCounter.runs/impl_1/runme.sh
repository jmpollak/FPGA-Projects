...
HD_PWD='C:/Users/polla/Documents/ECE 3300/BitCounter/BitCounter.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log bit_counter.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source bit_counter.tcl -notrace
